...
\label{a00113_source}\index{E:/Github/VitNX/VitNX/UI/BasedOnDarkUI/Controls/VitNX\_ProgressBar.cs@{E:/Github/VitNX/VitNX/UI/BasedOnDarkUI/Controls/VitNX\_ProgressBar.cs}}
...
\DoxyCodeLine{00063         \}}
\DoxyCodeLine{00064 }
\DoxyCodeLine{00065         \textcolor{keyword}{public} VitNX\_ProgressBar()}
...
\DoxyCodeLine{00079 }
\DoxyCodeLine{00080         \textcolor{keyword}{private} \textcolor{keywordtype}{void} DrawProgressBar(Graphics g)}
\DoxyCodeLine{00081         \{}
\DoxyCodeLine{00082             Rectangle rect = ClientRectangle;}
\DoxyCodeLine{00083             ProgressBarRenderer.DrawHorizontalBar(g, rect);}
\DoxyCodeLine{00084             \textcolor{keywordflow}{if} (Value > 0) \{ Rectangle clip = \textcolor{keyword}{new} Rectangle(rect.X, rect.Y, (\textcolor{keywordtype}{int})Math.Round((\textcolor{keywordtype}{float})Value / Maximum * rect.Width), rect.Height); g.FillRectangle(\_progressColourBrush, clip); \}}
\DoxyCodeLine{00085         \}}
\DoxyCodeLine{00086 }
\DoxyCodeLine{00087         \textcolor{keyword}{private} \textcolor{keywordtype}{void} DrawStringIfNeeded(Graphics g)}
\DoxyCodeLine{00088         \{}
\DoxyCodeLine{00089             \textcolor{keywordflow}{if} (VisualMode != VitNX\_ProgressBarDisplayMode.NoText)}
\DoxyCodeLine{00090             \{}
\DoxyCodeLine{00091                 \textcolor{keywordtype}{string} text = \_textToDraw;}
\DoxyCodeLine{00092                 SizeF len = g.MeasureString(text, TextFont);}
\DoxyCodeLine{00093                 Point location = \textcolor{keyword}{new} Point((Width / 2) -\/ (\textcolor{keywordtype}{int})len.Width / 2, (Height / 2) -\/ (\textcolor{keywordtype}{int})len.Height / 2);}
\DoxyCodeLine{00094                 g.DrawString(text, TextFont, \_textColourBrush, location);}
\DoxyCodeLine{00095             \}}
\DoxyCodeLine{00096         \}}
\DoxyCodeLine{00097 }
\DoxyCodeLine{00098         \textcolor{keyword}{public} \textcolor{keyword}{new} \textcolor{keywordtype}{void} Dispose()}
\DoxyCodeLine{00099         \{ \_textColourBrush.Dispose(); \_progressColourBrush.Dispose(); base.Dispose(); \}}
\DoxyCodeLine{00100 }
\DoxyCodeLine{00101         \textcolor{keyword}{private} \textcolor{keywordtype}{void} InitializeComponent()}
\DoxyCodeLine{00102         \{ SuspendLayout(); BackColor = Color.FromArgb(69, 73, 74); ResumeLayout(\textcolor{keyword}{false}); \}}
\DoxyCodeLine{00103     \}}
\DoxyCodeLine{00104 \}}
