...
namespace VitNX.Controls
{
    public class VitNX_NumericUpDown : NumericUpDown
    {
        ...
        protected override void OnMouseDown(MouseEventArgs e) { _mouseDown = true; Invalidate(); }
        protected override void OnMouseUp(MouseEventArgs mevent) { _mouseDown = false; Invalidate(); }
        ...
        private void VitNX_NumericUpDown_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (upHot && _mouseDown) { upIcon = ScrollIcons.scrollbar_arrow_small_clicked; }
            ...
            if (downHot && _mouseDown) { downIcon = ScrollIcons.scrollbar_arrow_small_clicked; }
