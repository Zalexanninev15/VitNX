...
{
    public class VNXNumericUpDown : NumericUpDown
    {
        [Browsable(false)]
        ...
        public VNXNumericUpDown()
        {
            ...
            Controls[0].Paint += VNXNumericUpDown_Paint;
        ...
        private void VNXNumericUpDown_Paint(object sender, PaintEventArgs e)
        {
            var g = e.Graphics;
