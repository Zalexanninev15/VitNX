...
namespace VitNX.Controls
{
    ...
    public class VitNXProgressBar : ProgressBar
    {
        ...
        public Color TextColor { get { return _textColourBrush.Color; } set { _textColourBrush.Dispose(); _textColourBrush = new SolidBrush(value); } }
        
        SolidBrush _progressColourBrush = (SolidBrush) Brushes.DodgerBlue;
        [Category("Additional Options"), Browsable(true), EditorBrowsable(EditorBrowsableState.Always)]
        public Color ProgressColor { get { return _progressColourBrush.Color; } set { _progressColourBrush.Dispose(); _progressColourBrush = new SolidBrush(value); } }
       
        VitNX_ProgressBarDisplayMode _visualMode = VitNX_ProgressBarDisplayMode.CurrProgress;
        [Category("Additional Options"), Browsable(true)]
        public VitNX_ProgressBarDisplayMode VisualMode { get { return _visualMode; } set { _visualMode = value; Invalidate(); } }

        string _text = string.Empty;
        [Description("If it's empty, % will be shown"), Category("Additional Options"), Browsable(true), EditorBrowsable(EditorBrowsableState.Always)]
        public string CustomText { get { return _text; } set { _text = value; Invalidate(); } }
        ...
        void InitializeComponent() { SuspendLayout(); BackColor = Color.FromArgb(69, 73, 74); ResumeLayout(false); }
    }
}