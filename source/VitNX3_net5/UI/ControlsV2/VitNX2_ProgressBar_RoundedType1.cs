...
{
    public class VitNX2_ProgressBarRoundedType1 : ProgressBar
    {
        ...
        public VitNX2_ProgressBarRoundedType1()
        {
            Value = Minimum;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            IntPtr hrgn = Import.CreateRoundRectRgn(0, 0, Width, Height, 7, 7);
