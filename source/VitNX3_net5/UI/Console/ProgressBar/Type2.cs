...
namespace VitNX3.UI.Console.ProgressBar
{
    ...
    public static class Type2
    {
        ...
        public static void PrintProgressToConsole(double progressPercentage,
            string textWithEvent)
        {
        ...
        private static void AddProgressValue(ref StringBuilder sb,
            double progressPercentage)
        {
            sb.Append(progressPercentage + "%" + " Complete");
        }

        private static void AddSpacingToString(ref StringBuilder sb,
            int progressCharsToPrint)
        {
        ...
        private static void AddProgressBar(ref StringBuilder sb,
            int progressCharsToPrint)
        {
