...
namespace VitNX.UI.ControlsV1.BasedOnDarkUI.Renderers
{
    public class VitNX_MenuRenderer : ToolStripRenderer
    {
        ...
        protected override void OnRenderItemCheck(ToolStripItemImageRenderEventArgs e)
        {
            ...
            if (e.Item.ImageIndex == -1 &&
                string.IsNullOrEmpty(e.Item.ImageKey) &&
                e.Item.Image == null)
            {
        ...
        protected override void OnRenderArrow(ToolStripArrowRenderEventArgs e)
        {
            ...
            e.ArrowRectangle = new Rectangle(new Point(e.ArrowRectangle.Left,
                e.ArrowRectangle.Top - 1),
                e.ArrowRectangle.Size);
